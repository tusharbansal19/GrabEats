...
const AboutCard = () => {
  return (
    <div className="card-wrapper flex flex-col items-center xl:flex-row bg-gradient-to-r from-black  to-orange-950 text-white p-4 rounded-lg max-w-full lg:max-w-lg shadow-lg transform transition-all duration-500">
